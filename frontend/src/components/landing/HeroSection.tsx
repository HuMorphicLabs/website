...
export default function HeroSection() {
  return (
    <section className="relative min-h-[92vh] pt-20 sm:pt-24 pb-12 flex flex-col items-center justify-center overflow-hidden cyber-grid">
      {/* Interactive Cyber Neural Particle Mesh Background */}
      <NeuralBackground />
      ...
      {/* Floating Holographic 3D HUD Widgets */}
      <HologramHUD />

      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col items-center text-center relative z-20">
        
        {/* Eyebrow Badge */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-cyan-500/40 bg-cyan-500/10 text-xs font-mono font-medium text-cyan-300 mb-4 backdrop-blur-md animate-float">
          <Sparkles className="w-3.5 h-3.5 text-cyan-400 animate-spin" />
          <span>AUTONOMOUS ROBOTICS OS - GEN-AI & ROS2 READY</span>
        </div>
