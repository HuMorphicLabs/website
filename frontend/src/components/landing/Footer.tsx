  ...
  return (
    <footer className="border-t border-slate-800/80 bg-[#02040b] text-slate-400 font-sans text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="space-y-3 font-mono">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#project-engine" className="hover:text-cyan-400 transition-colors">
                  4-Tier WBS
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#ai-copilot" className="hover:text-cyan-400 transition-colors">
                  AI Copilot
                </a>
              </li>
              <li>
          ...
          {/* Col 2: Organization */}
          <div className="space-y-3 font-mono">
            <h4 className="text-xs font-bold text-white uppercase tracking-wider">Organization</h4>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <a href="#gamification" className="hover:text-cyan-400 transition-colors">
                  Leaderboard
                </a>
              </li>
              <li>
                <a href="#attendance" className="hover:text-cyan-400 transition-colors">
                  Attendance System
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-[11px]">
          <div className="flex items-center gap-2 text-slate-400">
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping" />
            <span>ALL SYSTEMS OPERATIONAL · KERNEL v3.4</span>
          </div>

          <div className="text-slate-400">
            © {new Date().getFullYear()} HumorphicOS. Purpose-built for engineers who build the future.
          </div>
        </div>
      </div>
    </footer>
